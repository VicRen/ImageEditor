...
public class PictureColorRadio extends RadioButton implements ValueAnimator.AnimatorUpdateListener {
    ...
    public PictureColorRadio(Context context) {
        this(context, null, 0);
    }

    public PictureColorRadio(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(context, attrs, 0);
    }

    public PictureColorRadio(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initialize(context, attrs, defStyleAttr);
    }

    private void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PictureColorRadio);

        mColor = a.getColor(R.styleable.PictureColorRadio_image_color, Color.WHITE);
        mStrokeColor = a.getColor(R.styleable.PictureColorRadio_image_stroke_color, Color.WHITE);
