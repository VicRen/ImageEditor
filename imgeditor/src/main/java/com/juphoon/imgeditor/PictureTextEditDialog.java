...
public class PictureTextEditDialog extends Dialog implements View.OnClickListener,
    ...
    public PictureTextEditDialog(Context context, Callback callback) {
    ...
    public void reset() {
        setText(new PictureText(null, Color.WHITE));
    }
    ...
    private void onDone() {
        ...
        if (!TextUtils.isEmpty(text) && mCallback != null) {
            mCallback.onText(new PictureText(text, mEditText.getCurrentTextColor()));
        }
        dismiss();
    }
