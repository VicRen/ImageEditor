package com.juphoon.imgeditor.core.clip;
...
public class PictureClipWindow implements PictureClip {
    ...
    public void setClipWinSize(float width, float height) {
        ...
        if (!mFrame.isEmpty()) {
            PictureUtils.center(mWinFrame, mFrame);
    ...
    private void reset(float clipWidth, float clipHeight) {
        ...
        PictureUtils.fitCenter(mWinFrame, mFrame, CLIP_MARGIN);
        mTargetFrame.set(mFrame);
    }
    ...
    public boolean homing() {
        ...
        mTargetFrame.set(mFrame);
        PictureUtils.fitCenter(mWinFrame, mTargetFrame, CLIP_MARGIN);
